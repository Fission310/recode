...
public class Controls {
    public static final Input FARSHOOT = Input.LEFT_TRIGGER;
    ...
    public static final Input CLOSESHOOT = Input.LEFT_BUMPER; // TRIANGLE
    public static final Input UNTRANSFER = Input.DPAD_DOWN; // CIRCLE
